<template>
    <div class="orderComplete">
        <div class="orderComplete__inner" v-if="validOrder">
            ...
            <p class="orderComplete__inner-strapline">Thank you for your payment. You will receive your purchased <br>
                products shortly.</p>
        ...
        <div class="orderComplete__inner" v-else>
            ...
            <p class="orderComplete__inner-strapline">Sorry, the specified order number either does not exist or is not
